...
inline std::vector<rclcpp::Parameter> DefaultJointLimiterParams()
{
  return {
    ...
    rclcpp::Parameter("joint_limits.joint1.max_velocity", 2.0),
    ...
    rclcpp::Parameter("joint_limits.joint2.max_velocity", 2.0),
    ...
    rclcpp::Parameter("joint_limits.joint3.max_velocity", 2.0),
