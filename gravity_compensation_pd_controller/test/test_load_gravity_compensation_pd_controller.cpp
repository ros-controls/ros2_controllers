...
TEST(TestLoadGravityCompensationPDController, load_controller)
{
  ...
  cm.set_parameter({"test_gravity_compensation_pd_controller.params_file", test_file_path});
  cm.set_parameter(
    {"test_gravity_compensation_pd_controller.type",
     "gravity_compensation_pd_controller/GravityCompensationPDController"});

  ASSERT_NE(cm.load_controller("test_gravity_compensation_pd_controller"), nullptr);
}
