...
#ifndef GRIPPER_ACTION_CONTROLLER__VISIBILITY_CONTROL_H_
#define GRIPPER_ACTION_CONTROLLER__VISIBILITY_CONTROL_H_
...
#endif  // GRIPPER_ACTION_CONTROLLER__VISIBILITY_CONTROL_H_
