...
std::string plugin_package_ = "kinematics_interface_kdl";
...
params_.chainable_command_interfaces_ = parameters_interface->get_parameter("chainable_command_interfaces").as_string_array();}
...
auto p_kinematics_plugin_package = rclcpp::ParameterValue(params_.kinematics_.plugin_package_);
parameters_interface->declare_parameter("kinematics.plugin_package", p_kinematics_plugin_package);
} else {
params_.kinematics_.plugin_package_ = parameters_interface->get_parameter("kinematics.plugin_package").as_string();}
...
params_.ft_sensor_.filter_coefficient_ = parameters_interface->get_parameter("ft_sensor.filter_coefficient").as_double();}
...
params_.fixed_world_frame_.external_ = parameters_interface->get_parameter("fixed_world_frame.external").as_bool();}
...
params_.gravity_compensation_.frame_.id_ = parameters_interface->get_parameter("gravity_compensation.frame.id").as_string();}
if (!parameters_interface->has_parameter("gravity_compensation.frame.external")){
auto p_gravity_compensation_frame_external = rclcpp::ParameterValue(params_.gravity_compensation_.frame_.external_);
parameters_interface->declare_parameter("gravity_compensation.frame.external", p_gravity_compensation_frame_external);
} else {
params_.gravity_compensation_.frame_.external_ = parameters_interface->get_parameter("gravity_compensation.frame.external").as_bool();}
...
params_.gravity_compensation_.CoG_.pos_ = parameters_interface->get_parameter("gravity_compensation.CoG.pos").as_double_array();}
...
params_.gravity_compensation_.CoG_.force_ = parameters_interface->get_parameter("gravity_compensation.CoG.force").as_double();}
...
params_.admittance_.selected_axes_ = parameters_interface->get_parameter("admittance.selected_axes").as_bool_array();}
...
params_.admittance_.damping_ratio_ = parameters_interface->get_parameter("admittance.damping_ratio").as_double_array();}
...
auto p_enable_parameter_update_without_reactivation = rclcpp::ParameterValue(params_.enable_parameter_update_without_reactivation_);
...
params_.enable_parameter_update_without_reactivation_ = parameters_interface->get_parameter("enable_parameter_update_without_reactivation").as_bool();}
...
params_.use_feedforward_commanded_input_ = parameters_interface->get_parameter("use_feedforward_commanded_input").as_bool();}
