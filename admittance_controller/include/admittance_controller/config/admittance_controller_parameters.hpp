...
namespace admittance_controller {
  struct Params {
    ...
    bool use_feedforward_commanded_input = true;
    struct Kinematics {
  ...
  public:
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter("kinematics.group_name")) {
        rcl_interfaces::msg::ParameterDescriptor descriptor;
        descriptor.description = "specifies the group name for planning with Moveit";
        descriptor.read_only = false;
        auto parameter = rclcpp::ParameterValue(params_.kinematics.group_name);
        parameters_interface_->declare_parameter("kinematics.group_name", parameter, descriptor);
      }
      ...
      if (!parameters_interface_->has_parameter("use_feedforward_commanded_input")) {
        rcl_interfaces::msg::ParameterDescriptor descriptor;
        ...
        descriptor.read_only = false;
        auto parameter = rclcpp::ParameterValue(params_.use_feedforward_commanded_input);
        parameters_interface_->declare_parameter("use_feedforward_commanded_input", parameter, descriptor);
      }
      ...
      param = parameters_interface_->get_parameter("kinematics.group_name");
      params_.kinematics.group_name = param.as_string();
      ...
      param = parameters_interface_->get_parameter("use_feedforward_commanded_input");
      params_.use_feedforward_commanded_input = param.as_bool();
