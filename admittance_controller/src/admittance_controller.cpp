...
namespace admittance_controller {
  ...
  CallbackReturn AdmittanceController::on_init() {
    ...
    try {
      admittance_->parameter_handler = std::make_shared<admittance_struct_parameters::admittance_struct>(
          get_node()->get_node_parameters_interface());
      admittance_->parameters_ = std::make_shared<admittance_struct_parameters::admittance_struct::params>(
          admittance_->parameter_handler->params_);
    } catch (const std::exception &e) {
