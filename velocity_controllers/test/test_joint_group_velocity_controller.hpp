...
protected:
  ...
  CommandInterface::SharedPtr joint_1_cmd_ =
    std::make_shared<CommandInterface>(joint_names_[0], HW_IF_VELOCITY, &joint_commands_[0]);
  CommandInterface::SharedPtr joint_2_cmd_ =
    std::make_shared<CommandInterface>(joint_names_[1], HW_IF_VELOCITY, &joint_commands_[1]);
  CommandInterface::SharedPtr joint_3_cmd_ =
    std::make_shared<CommandInterface>(joint_names_[2], HW_IF_VELOCITY, &joint_commands_[2]);
