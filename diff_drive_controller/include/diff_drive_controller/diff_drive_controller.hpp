...
class DiffDriveController : public controller_interface::ControllerInterface
{
 ...
 private:
   ...
   CallbackReturn configure_side(const std::string& side,
   ...
   std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Odometry>> odometry_publisher_{nullptr};
   std::shared_ptr<realtime_tools::RealtimePublisher<nav_msgs::msg::Odometry>> realtime_odometry_publisher_{nullptr};

   std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<tf2_msgs::msg::TFMessage>> odometry_transform_publisher_{nullptr};
