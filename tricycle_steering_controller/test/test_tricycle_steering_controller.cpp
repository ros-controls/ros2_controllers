...
TEST_F(TricycleSteeringControllerTest, check_exported_intefaces)
{
  ...
  EXPECT_EQ(
    command_intefaces.names[STATE_DRIVE_RIGHT_WHEEL],
    rear_wheels_names_[STATE_DRIVE_RIGHT_WHEEL] + "/" + traction_interface_name_);
  EXPECT_EQ(
    command_intefaces.names[STATE_DRIVE_LEFT_WHEEL],
    rear_wheels_names_[STATE_DRIVE_LEFT_WHEEL] + "/" + traction_interface_name_);
  EXPECT_EQ(
  ...
  EXPECT_EQ(
    state_intefaces.names[STATE_DRIVE_RIGHT_WHEEL],
    rear_wheels_names_[STATE_DRIVE_RIGHT_WHEEL] + "/" + traction_interface_name_);
  EXPECT_EQ(
    state_intefaces.names[STATE_DRIVE_LEFT_WHEEL],
    rear_wheels_names_[STATE_DRIVE_LEFT_WHEEL] + "/" + traction_interface_name_);
  EXPECT_EQ(
...
//   ASSERT_EQ(controller_->on_configure(rclcpp_lifecycle::State()), NODE_SUCCESS);
//   ASSERT_EQ(controller_->on_activate(rclcpp_lifecycle::State()), NODE_SUCCESS);
//   ASSERT_EQ(controller_->command_interfaces_[CMD_STEER].get_value(), 101.101);
//   ASSERT_EQ(controller_->on_deactivate(rclcpp_lifecycle::State()), NODE_SUCCESS);
//   ASSERT_TRUE(std::isnan(controller_->command_interfaces_[CMD_STEER].get_value()));
//   ASSERT_EQ(controller_->on_activate(rclcpp_lifecycle::State()), NODE_SUCCESS);
//   ASSERT_TRUE(std::isnan(controller_->command_interfaces_[CMD_STEER].get_value()));
...
// TEST_F(TricycleSteeringControllerTest, test_setting_slow_mode_service)
// {
//   SetUpController();
...
// TEST_F(TricycleSteeringControllerTest, test_update_logic_fast)
// {
//   SetUpController();
//   rclcpp::executors::MultiThreadedExecutor executor;
//   executor.add_node(controller_->get_node()->get_node_base_interface());
...
//   EXPECT_EQ(joint_command_values_[STATE_DRIVE_RIGHT_WHEEL], TEST_DISPLACEMENT);
