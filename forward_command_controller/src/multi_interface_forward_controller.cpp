...
MultiInterfaceForwardController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
MultiInterfaceForwardController::state_interface_configuration() const
{
...
CallbackReturn MultiInterfaceForwardController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

CallbackReturn MultiInterfaceForwardController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::return_type MultiInterfaceForwardController::update()
{
