...
protected:
  ...
  hardware_interface::StateInterface imu_orientation_x_{sensor_name_, "orientation.x",
    &sensor_values_[0]};
  hardware_interface::StateInterface imu_orientation_y_{sensor_name_, "orientation.y",
    &sensor_values_[1]};
  hardware_interface::StateInterface imu_orientation_z_{sensor_name_, "orientation.z",
    &sensor_values_[2]};
  hardware_interface::StateInterface imu_orientation_w_{sensor_name_, "orientation.w",
    &sensor_values_[3]};
  hardware_interface::StateInterface imu_angular_velocity_x_{sensor_name_, "angular_velocity.x",
    &sensor_values_[4]};
  hardware_interface::StateInterface imu_angular_velocity_y_{sensor_name_, "angular_velocity.y",
    &sensor_values_[5]};
  hardware_interface::StateInterface imu_angular_velocity_z_{sensor_name_, "angular_velocity.z",
    &sensor_values_[6]};
  hardware_interface::StateInterface imu_linear_acceleration_x_{sensor_name_,
    "linear_acceleration.x", &sensor_values_[7]};
  hardware_interface::StateInterface imu_linear_acceleration_y_{sensor_name_,
    "linear_acceleration.y", &sensor_values_[8]};
  hardware_interface::StateInterface imu_linear_acceleration_z_{sensor_name_,
