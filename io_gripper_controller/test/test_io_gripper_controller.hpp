...
protected:
  ...
  void setup_parameters()
  {
    ...
    controller_->get_node()->set_parameter(
      {"open.set_before_command.high", open_set_before_command_high});
    controller_->get_node()->set_parameter(
      {"open.set_before_command.low", open_set_before_command_low});
    ...
    controller_->get_node()->set_parameter(
      {"open.set_after_command.high", open_set_after_command_high});
    controller_->get_node()->set_parameter(
    ...
    controller_->get_node()->set_parameter(
      {"close.set_before_command.low", close_set_before_command_low});
    ...
    controller_->get_node()->set_parameter(
      {"close.state.empty_close.joint_states", close_joint_states});
    ...
    controller_->get_node()->set_parameter(
      {"close.state.empty_close.set_after_command_high", close_set_after_command_high});
    controller_->get_node()->set_parameter(
      {"close.state.empty_close.set_after_command_low", close_set_after_command_low});
    controller_->get_node()->set_parameter(
      {"close.state.full_close.joint_states", close_joint_states});
    ...
    controller_->get_node()->set_parameter(
      {"close.state.full_close.set_after_command_high", close_set_after_command_high});
    controller_->get_node()->set_parameter(
      {"close.state.full_close.set_after_command_low", close_set_after_command_low});
    ...
    controller_->get_node()->set_parameter(
      {"configuration_setup.stichmass_125.joint_states", stichmass_joint_states});
    controller_->get_node()->set_parameter(
      {"configuration_setup.stichmass_125.command_high", stichmass_command_high});
    controller_->get_node()->set_parameter(
      {"configuration_setup.stichmass_125.command_low", stichmass_command_low});
    controller_->get_node()->set_parameter(
      {"configuration_setup.stichmass_125.state_high", stichmass_state_high});
    controller_->get_node()->set_parameter(
      {"configuration_setup.stichmass_125.state_low", stichmass_state_low});

    controller_->get_node()->set_parameter({"gripper_specific_sensors", gripper_specific_sensors});
    controller_->get_node()->set_parameter(
      {"sensors_interfaces.hohenabfrage.input", gripper_interfaces_input});
  }
