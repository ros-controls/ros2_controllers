...
TEST_F(ForceTorqueSensorBroadcasterTest, SensorName_IsEmpty_InterfaceNames_NotSet)
{
  ...
  fts_broadcaster_->get_lifecycle_node()->set_parameter({"sensor_name", ""});
...
TEST_F(ForceTorqueSensorBroadcasterTest, InterfaceNames_IsEmpty_SensorName_NotSet)
{
  ...
  fts_broadcaster_->get_lifecycle_node()->set_parameter({"interface_names.force.x", ""});
  fts_broadcaster_->get_lifecycle_node()->set_parameter({"interface_names.torque.z", ""});
