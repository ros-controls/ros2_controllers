...
{
  sensor_name_ = lifecycle_node_->get_parameter("sensor_name").as_string();
  interface_names_[0] = lifecycle_node_->get_parameter("interface_names.force.x").as_string();
  interface_names_[1] = lifecycle_node_->get_parameter("interface_names.force.y").as_string();
  interface_names_[2] = lifecycle_node_->get_parameter("interface_names.force.z").as_string();
  interface_names_[3] = lifecycle_node_->get_parameter("interface_names.torque.x").as_string();
  interface_names_[4] = lifecycle_node_->get_parameter("interface_names.torque.y").as_string();
  interface_names_[5] = lifecycle_node_->get_parameter("interface_names.torque.z").as_string();
  ...
  frame_id_ = lifecycle_node_->get_parameter("frame_id").as_string();
  if (frame_id_.empty())
  {
    RCLCPP_ERROR(lifecycle_node_->get_logger(), "'frame_id' parameter has to be provided.");
    return CallbackReturn::ERROR;
  }
  ...
  try
  {
    ...
    sensor_state_publisher_ = lifecycle_node_->create_publisher<geometry_msgs::msg::WrenchStamped>(
  ...
  RCLCPP_DEBUG(lifecycle_node_->get_logger(), "configure successful");
  return CallbackReturn::SUCCESS;
}
